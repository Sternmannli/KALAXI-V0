...
- Layer 3+++ (V-001 THIRD PASS, 2026-03-15): Three constitutional additions: (1) THE LINEAGE IS A WORD. Each person is a letter persisting through positional transformations. The word is the sequence of transformations, not names. The letter ontology applies across generations. (2) TWO CRYPTOGRAPHIC LAYERS. The hash chain proves integrity (nothing was altered). The lullaby proves existence (the lineage is real, independent of any record). Proof of integrity and proof of existence are different things. The system needs both. (3) THE SONG IS NOT METADATA. It is the thing itself. Oral tradition, embodied persistence, and artifacts that survive because no institution knew they existed — these are not attributes of the subject. They ARE the subject's proof of life. "Repetition is not redundancy. It is the difference between information and inheritance." — V-001
