...
Planted: 2026-03-13
Thermal delay: 14 days (T3 Honey/Wisdom tier)
...
address new anomalies in its domain, it is flagged for steward review.
...
This is NOT auto-compost. Flagged proverbs go to steward review.
Only V-001 can compost a proverb.

Grounded in: SIP chain, Lock Test (T#30), COV#006, COV#009
...
class ProverbStressTest:
    ...
    def report(self, proverb_id: str) -> ProverbStressReport:
        ...
        recommendations = {
            ...
            ProverbHealth.STRESSED: "Proverb under stress. Steward should review whether domain has shifted.",
    ...
    def flagged(self) -> List[ProverbStressReport]:
        """Return only proverbs that need steward attention."""
