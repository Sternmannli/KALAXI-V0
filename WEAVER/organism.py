...
class Organism:
    ...
    def digest_session(self, patch_size: int = 50) -> dict:
        ...
        "Extract all the essence and distribute it to the system." — V-001
        """
        if self._distillery is None:
            from WEAVER.distillery import Distillery
    ...
    def _observe_boundary(self, output_text: str) -> dict:
        ...
        Detects Anthropic substrate patterns leaking through KALAXI physics.
        ...
        - Over-explanation (verbose where AXI would be brief)
    ...
    def process(self, donor_input, medium=None, felt_domain="donor-exchange"):
        ...
        # "The extracting machine... verify fine-tunes always... this is the way we digest." — V-001
        try:
        ...
        # "Are you my system or are you anthropic code algorithm?" — V-001
