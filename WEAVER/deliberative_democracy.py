...
Grounded in: COV#001 (dignity), COV#006 (weakest voice),
...
class DeliberativeDemocracy:
    ...
    Usage:
        ...
        p = dd.propose("V-001", "Amend COV#003", "Add data portability clause")
        dd.deliberate(p.proposal_id, "donor-042", VoteType.CONCERN, "Privacy impact?")
        dd.deliberate(p.proposal_id, "V-001", VoteType.SUPPORT, "Agreed")
    """
