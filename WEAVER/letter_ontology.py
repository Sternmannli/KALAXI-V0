#!/usr/bin/env python3
"""
letter_ontology.py — Arabic Letter Ontology for KALAXI Chain Architecture
...
LAM = Letter(
    ...
    allowed_forms={PositionalForm.INITIAL, PositionalForm.MEDIAL, PositionalForm.FINAL},
    system_role="binding",
    description="Binding. Creates obligation between elements. The covenant connector.",
)
