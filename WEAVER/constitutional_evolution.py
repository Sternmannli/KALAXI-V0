...
The constitution (covenants) must evolve — but slowly, with
...
Grounded in: COV#001, COV#009, Centre-Shift (3-year consensus + 1000-day cooling),
...
class Amendment:
    ...
    amendment_id: str
    target_covenant: str       # e.g. "COV#003"
    tier: AmendmentTier
    title: str
    description: str
    proposed_by: str
